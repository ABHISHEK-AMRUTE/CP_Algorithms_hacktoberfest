 ...
 * College: University Politehnica of Bucharest
 *
 * The Range Minimum Query problem consists of efficiently answering queries of
 * the form "what is the minimum number in the inverval [left, right]" for
 * a given array.
 *
